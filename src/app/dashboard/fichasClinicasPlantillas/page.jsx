                ...
                <div className="mb-8 sm:mb-10">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                        ...
                        <button
                            ...
                            className="group inline-flex items-center gap-2.5 px-5 py-2.5 text-sm font-semibold text-white rounded-xl bg-black hover:bg-slate-800 active:scale-[0.98] transition-all duration-150 shadow-sm self-start sm:self-auto"
                        >
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between px-4 sm:px-6 py-4 sm:py-5 gap-4">
                                ...
                                <div className="flex items-center gap-2 sm:gap-2.5 flex-shrink-0 pl-14 sm:pl-0">
                                    <button
                                        ...
                                        className="inline-flex h-8 items-center justify-center gap-1.5 rounded-lg bg-black px-3 text-xs font-semibold text-white shadow-sm transition-all duration-150 hover:bg-slate-800 active:scale-[0.97] sm:h-9 sm:px-4"
                                    >
