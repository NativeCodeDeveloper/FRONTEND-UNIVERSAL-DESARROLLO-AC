            ...
            <div className="mx-auto w-full max-w-6xl px-6 py-10 space-y-8">
                ...
                <div className="rounded-[32px] border border-slate-200 bg-white/90 p-6 shadow-sm">
                    <div className="flex flex-col gap-1">
                        <h1 className="text-xl font-semibold tracking-tight text-slate-900 md:text-2xl">Publicaciones Tratamientos</h1>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 gap-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <label className="cursor-pointer inline-flex items-center gap-2 rounded-xl border border-dashed border-slate-200 bg-slate-50 px-5 py-3 text-sm font-medium text-slate-600 transition hover:border-slate-300 hover:bg-slate-100 hover:text-slate-900 max-w-full">
                                    ...
                                    <div className="p-4 sm:p-5 space-y-3">
                                        ...
                                        <div className="flex flex-wrap items-center gap-2">
                                            <button
                                                ...
                                                className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-100 px-3.5 py-2 text-xs font-semibold text-slate-900 transition hover:bg-slate-200"
                                            >
                        ...
                        {dataPublicaciones.map((item) => (
                            <div key={item.id_publicacionesTituloDescripcion} className="flex items-start gap-3 p-4">
                                ...
                                <div className="min-w-0 flex-1 space-y-1.5">
                                    ...
                                    <ButtonDinamic className="rounded-lg border border-slate-200 bg-slate-100 text-slate-900 hover:bg-slate-200" onClick={() => seleccionarPublicacionesTituloDetallePorID(item.id_publicacionesTituloDescripcion)}>
                                        Seleccionar
                                    </ButtonDinamic>
                                </div>
                            </div>
