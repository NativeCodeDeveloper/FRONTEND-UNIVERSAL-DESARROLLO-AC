...
const CTA1 = () => (
    <div className="w-full bg-red-50/40 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <div className="mx-auto flex max-w-3xl items-center justify-center">
            <div className="mt-8 w-full overflow-hidden rounded-3xl border border-red-100 bg-white shadow-sm lg:mt-14">
                ...
                <div className="flex flex-col items-center gap-5 px-6 py-8 text-center sm:px-10 sm:py-10 lg:px-16">
                    ...
                    <Link href="/" className="w-full sm:w-auto">
                        <Button className="h-12 w-full gap-3 rounded-xl bg-red-600 px-6 text-sm font-semibold text-white transition-colors hover:bg-red-700 sm:w-auto">
